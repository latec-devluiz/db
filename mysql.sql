CREATE DATABASE  IF NOT EXISTS `libertas` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `libertas`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: libertas
-- ------------------------------------------------------
...
INSERT INTO `tb_users` VALUES (1,'luiz','luiz@latecsolucoes.com.br','123456','2024-04-17 18:57:44');
/*!40000 ALTER TABLE `tb_users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'libertas'
--

--
-- Dumping routines for database 'libertas'
--
